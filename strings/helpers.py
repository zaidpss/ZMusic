...
ـ /رفع ادمن او /auth [ الرد على المستخدم / معرف المستخدم ] : إضافة مستخدم إلى قائمة المصرح بهم في البوت.

ـ /تنزيل ادمن او /unauth [ الرد على المستخدم / معرف المستخدم ] : إزالة مستخدم مصرح به من قائمة المصرح بهم.
