...
OWNER_ID = int(getenv("OWNER_ID", 6899139149))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/zaidpss/ZMusic",
)
...
CHANNEL_NAME = getenv("CHANNEL_NAME", "سورس طربوش")
CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/trboos")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/trboos")
